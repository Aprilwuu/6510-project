---
title: "DASC 6510 Project ANOVA Models"
...
Note that the p-value associated with the date:seed interaction is given by

```         
0.0832838.
```

Despite being greater than $\alpha = 0.05$, I decided to keep this term in the model as it was very close.
...
Note that the p-value associated with the date:variety:seed interaction is given by

```         
0.1111.
```

However, in the previous reduced model, the p-value associated with the date:variety:seed interaction was less than $\alpha=0.05$. Therefore, I decided to keep this term in the final model out of an abundance of caution.
